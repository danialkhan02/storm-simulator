...
def volcanoState():
    global lastPos1
    volcanFile = open("explodeScale.txt","r")
    checkLast = volcanFile.readline()
    if checkLast != "":
        lastPos1 = checkLast
    else:
        lastPos1 = 38
    volcanFile.close() 
    volcanFile = (int(lastPos1) + 200)/42
    return volcanFile
def denState():
    global density
...
VEI = volcanoState()*(50)                    #how fast the tornado wind speeds are in km/h
density = denState()                        #how dense the population is with 1 being medium density
startpoint1 = (790,500)
startpoint2 = (790,500)
startpoint3 = (790,210)
def procedure():
...
def volcanoSimulator():
    ...
    if compresscounter % 1 == 0:    
        ...
        pygame.draw.rect(screen, (0,0,0), (950,100,50,500))
